...
Route::get('designs/slug/{id}', 'Designs\DesignController@findbySlug');
...
Route::get('search/designers', 'User\DesignController@search');




//Route group authentication users only
